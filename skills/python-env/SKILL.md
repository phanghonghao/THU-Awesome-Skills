...
| 版本 | 路径 |
|------|------|
| 3.12 | `<PYTHON_ROOT>/Python312/python.exe` |
| 3.14 | `<PYTHON_ROOT>/Python314/python.exe` |
...
2. 验证目标 Python 存在：
```bash
"<PYTHON_ROOT>/Python3XX/python.exe" --version
```
...
4. 创建 .venv（如需要）：
```bash
"<PYTHON_ROOT>/Python3XX/python.exe" -m venv "<PROJECT_ROOT>/.venv"
```
